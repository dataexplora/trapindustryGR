...
const TrackRow: React.FC<TrackRowProps> = ({ track, rank }) => {
  ...
  return (
    <div className="flex items-center p-4 bg-dark-card rounded-xl border border-dark-border hover:bg-dark-card-hover transition-all duration-200">
      {/* Rank */}
      <div className="mr-4 bg-gradient-to-r from-indigo-800 to-purple-700 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold shrink-0">
        {rank}
      </div>
      
      {/* Album Cover */}
      {track.album_image?.url && (
